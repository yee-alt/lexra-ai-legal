...
const products = [
  ...
  },
  {
    id: "medical",
    name: "Medical AI",
    tagline: "Next-Generation Clinical Intelligence",
    desc: "AI-powered diagnostics and clinical decision support. Bringing the same rigor and explainability we built for legal AI to the healthcare industry.",
    icon: Stethoscope,
    tag: "Coming Soon",
    features: [
      { icon: Shield, title: "Clinical Decision Support", desc: "AI-assisted diagnosis with explainable reasoning." },
      { icon: FileText, title: "Medical Records Analysis", desc: "Intelligent extraction and summarization of patient data." },
      { icon: BarChart3, title: "Outcome Prediction", desc: "Data-driven patient outcome modeling." },
      { icon: Globe, title: "Regulatory Compliance", desc: "Built for healthcare compliance from day one." },
    ],
  },
];
